...
export const constantRoutes = [{
...

    {
        ...
        name: 'Example',
        // meta: { title: '短信', icon: 'example' },
        children: [{
                path: 'table',
                name: 'Table',
                component: () =>
                    import ('@/views/table/index'),
                meta: { title: '短信', icon: 'dashboard' }
    ...
    {
        path: 'external-link', // 外部
        component: Layout,
        children: [{
            path: 'http://www.yueqizhixiang.com/',
            meta: { title: '乐器之乡', icon: 'link' }
        }]
    },
